...
class GiteeProvider(BaseProvider):
    ...
    def get_supported_ratios(self) -> dict[str, list[str]]:
        ...
        return {
            ...
            "4:3": ["768x576", "1152x896", "2048x1536"],
            "3:4": ["576x768", "896x1152", "1536x2048"],
            "3:2": ["1152x768", "1536x1024", "2048x1360"],
            "2:3": ["768x1152", "1024x1536", "1360x2048"],
            "16:9": ["640x360", "1024x576", "2048x1152"],
            "9:16": ["360x640", "576x1024", "1152x2048"],
        }
